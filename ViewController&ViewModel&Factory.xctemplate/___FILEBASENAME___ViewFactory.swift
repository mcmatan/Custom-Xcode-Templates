...
class ___VARIABLE_productName:identifier___VCFactory: Factory {
    func create() -> ___VARIABLE_productName:identifier___VC {
        ...
        self.container.autoregister(___VARIABLE_productName:identifier___VC.self, argument: ___VARIABLE_productName:identifier___ViewModelType.self, initializer: ___VARIABLE_productName:identifier___VC.init)
        return self.container.resolve(___VARIABLE_productName:identifier___VC.self, argument: viewModel)!
    }
}
